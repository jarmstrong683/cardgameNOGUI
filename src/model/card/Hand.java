...
public interface Hand {
	 ...
	 * 
	 * @param card to be added (or rejected) to the hand
	 ...
	 * 
	 * @return {@code true} if the hand contains no cards; otherwise {@code false}
	 */
	public boolean isEmpty();

	/**
	 * Returns the number of cards currently held by the hand. Returns 0 if the hand
	 * is empty.
	 * 
	...
	/**
	 * Returns the total score based on the {@link model.card.Rank} of every card
	 * currently held in the hand. Returns 0 if the hand is empty.
	 * 
	 ...
	 * parameter the method shall return 0. It should also return 0 if the supplied
	 * parameter is {@code null}.
	 * 
	 * @param suit the suit for which to count the number of cards in the hand
	 * 
	 ...
	 * <li>Hand of 4 cards [Ace of Clubs, 4 of Diamonds, Queen of Clubs, Ace of
	 * Diamonds] Score: 16
	 * </ul>
	 * 

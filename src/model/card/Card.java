...
public interface Card extends Comparable<Card> {
	 ...
	 * 
	 * <p>
	 * The same rules of reflexivity, symmetry, transitivity, and consistency apply.
	 * However, the two object should be tested and treated as
	 ...
	 * 
	 * @return {@code true} if this {@link model.card.Card} object is the same as
	...
	/**
	 * Override {@link java.lang.Comparable#compareTo(Object)} Compares this Card
	 * with the supplied Card for order. Returns a negative integer, zero, or a
	 * positive integer if this Card is less than, equal to, or greater than the
	 * supplied Card.
	 * 
	 * <p>

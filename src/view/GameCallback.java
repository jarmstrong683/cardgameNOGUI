...
public interface GameCallback {
	/**
	 * Updates the view about a {@link model.Player} added to the game engine. This
	 * information should be logged using Logger info level.
	 * 
	...
	/**
	 * Updates the view about a {@link model.Player} removed from the game engine.
	 ...
	 * {@link model.Player}
	 * 
	 * @param player the {@link model.Player} who was dealt a card
	 * @param card   the {@link model.card.Card} that was dealt
	 * 
	 * @see model.Player
	 * @see model.card.Card
	 */
	...
	/**
	 * Updates the view when a {@link model.card.Card} was unsuccessfully dealt to a
	 * {@link model.Player} and the player bust.
	 * 
	 * @param player the {@link model.Player} who was unsuccessfully dealt the card
	 * @param card   the {@link model.card.Card} that was attempted to be dealt to
	 *               the player
	 * 
	 * @see model.Player
	 * @see model.card.Card
	 ...
	 * House
	 * 
	 * @param houseHand the House's {@link model.card.Hand}
	 * @param card      the {@link model.card.Card} that was dealt to the House
	 * 
	 * @see model.card.Hand
	 * @see model.card.Card
	 */
	...
	/**
	 * Updates the view when a {@link model.card.Card} was unsuccessfully dealt to
	 * the House
	 * 
	 * @param houseHand the House's {@link model.card.Hand}
	 * @param card      the {@link model.card.Card} that was attempted to be dealt
	 *                  to the House
	 * 
	 * @see model.card.Hand
	 * @see model.card.Card
